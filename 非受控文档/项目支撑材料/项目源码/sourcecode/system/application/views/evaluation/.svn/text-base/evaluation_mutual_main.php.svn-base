   		...
   		<div class="sidebar">
            ...
            <ul class="sidebar_nav">
                ...
                <li><a href=<?php echo site_url("evaluation/frominstructor")?>>老师评价</a></li>
                 <li><a href=<?php echo site_url("evaluation/mutualmain")?>>评价标准</a></li>
            </ul>
   	</div>
        ...
        请您在开始评价之前仔细阅读评价细则。</p>
          ...
          <div class="main" align="center"><br />
           ...
           <table width="200" border="1" align="center" style="font-size:12px">
              ...
              <tr align="center">
                <th width="100">角色</th>
                <th width="100"><b>组员名称</b></th>
              </tr>
              <?php  { ?>
               <tr align="center">
                <td><a href="evaluation/mutual/<?php  ?>"><?php ?></a></td>
                <td><a href="caseadmin/mutual/<?php  ?>"><?php ?></a></td>
              <?php	
              }?>
            </table>
            <br />
