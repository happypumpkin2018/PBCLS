    ...
    <div class="maincontent">
    	...
    	<div class="sidebar">
            ...
            <ul class="sidebar_nav">
                ...
                <li><a href=<?php echo site_url("evaluation/selfevaluation")?>>评价细则</a></li>
            </ul>
   	   </div>
        ...
        <div class="mainbody">
          ...
          <div class="main" align="center">
            ...
            <tr align="center"><td>综合评价</td><td colspan="2"><input name="evaluation" type="text" size="40" value="" /></td></tr>
            <tr align="center"><td>学习展望</td><td colspan="2"><input name="expectation" type="text" size="40" value="" /></td></tr>
